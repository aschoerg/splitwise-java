package com.github.sritejakv.spitwise;

import com.github.scribejava.core.model.OAuth1AccessToken;
import com.github.scribejava.core.model.Response;
import com.github.scribejava.core.model.Token;
import com.github.scribejava.core.model.Verb;
import com.github.sritejakv.spitwise.constants.Strings;
import com.github.sritejakv.spitwise.constants.URL;
import com.github.sritejakv.spitwise.utils.OAuthUtil;
import com.github.sritejakv.spitwise.utils.Splitwise10Api;
...
/**
 * Java SDK for com.github.sritejakv.spitwise.Splitwise. Authentication is done using OAuth1.0
 */
public class Splitwise {
	 ...
	 *
	 * @param userId com.github.sritejakv.spitwise.Splitwise id of the user
	...
	public String getExpenses(Map<String, String> filterParams) throws Exception {
		Response response;
		if (filterParams == null) {
			response = this.util.makeRequest(URL.GET_EXPENSES, Verb.GET);
		} else {
			response = this.util.makeRequest(URL.GET_EXPENSES, Verb.GET, filterParams);
		}
		if (response.getCode() == 200)
			return response.getBody();
		return null;
